...
await $`magick -size 1200x630 xc:"#0b1220" \
  ...
  -fill "#e2e8f0" -font "Menlo" -pointsize 24 -annotate +420+380 "curl -fsSL https://bvm-core.nexsail.top/install | bash" \
  -annotate +420+418 "irm https://bvm-core.nexsail.top/install | iex" \
